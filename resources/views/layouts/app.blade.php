                ...
                <ul class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
                    ...
                    <li class="user-header bg-primary">
                        ...
                        <p>
                            ...
                            <small>Member since @if(isset(Auth::user()->created_ate)){{ Auth::user()->created_at->format('M. Y') }}@endif</small>
                        </p>
                    </li>
                    <!-- Menu Footer-->
                    <li class="user-footer">
                        <a href="{{ url('change-password') }}#" class="btn btn-default btn-flat">Profile</a>
...
<!-- Content Wrapper. Contains page content -->
    ...
    <footer class="main-footer">
        ...
        <strong>
           Copyright &copy; {{date('Y')}} <a href="https://adminlte.io">KELOMPOK 3</a>.
        </strong>
        All rights reserved.
    </footer>
</div>
